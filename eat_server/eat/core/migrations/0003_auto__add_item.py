...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_item', (
            ...
            ('nuts', self.gf('django.db.models.fields.BooleanField')()),
            ('dairy', self.gf('django.db.models.fields.BooleanField')()),
            ('gluten', self.gf('django.db.models.fields.BooleanField')()),
            ('eggs', self.gf('django.db.models.fields.BooleanField')()),
        ))
