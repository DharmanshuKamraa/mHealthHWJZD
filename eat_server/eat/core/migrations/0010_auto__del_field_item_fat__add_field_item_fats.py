...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.fats'
        db.add_column(u'core_item', 'fats',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.fats'
        db.delete_column(u'core_item', 'fats')
    ...
    models = {
        ...
        u'core.item': {
            ...
            'fats': ('django.db.models.fields.CharField', [], {'default': "'2'", 'max_length': '255', 'null': 'True'}),
