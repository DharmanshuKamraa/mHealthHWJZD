...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_item', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='http://globe-views.com/dcim/dreams/eggs/eggs-03.jpg', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.image'
        db.delete_column(u'core_item', 'image')
