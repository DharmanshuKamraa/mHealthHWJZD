...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_item', 'item_type',
                      self.gf('django.db.models.fields.CharField')(default='VEGETABLES', max_length=255),
                      keep_default=False)

        # Adding field 'Item.price_per_saving'
        db.add_column(u'core_item', 'price_per_saving',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_item', 'item_type')

        # Deleting field 'Item.price_per_saving'
        db.delete_column(u'core_item', 'price_per_saving')
